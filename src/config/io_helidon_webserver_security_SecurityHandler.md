Type:
[io.helidon.webserver.security.SecurityHandler](https://helidon.io/docs/v4/apidocs/io.helidon.webserver.security/io/helidon/webserver/security/SecurityHandler.html)
