...
| [Jakarta Persistence (JPA)](../mp/persistence.md#jakarta-persistence-jpa)               | [3.1](https://jakarta.ee/specifications/persistence/3.1/jakarta-persistence-spec-3.1.html)         | Management of persistence and object/relational mapping     |
| [Jakarta Transactions (JTA)](../mp/persistence.md#jakarta-transactions-jta-integration) | [2.0](https://jakarta.ee/specifications/transactions/2.0/jakarta-transactions-spec-2.0.html)       | Allows handling transactions consistent with X/Open XA-spec |
...
- Try the [Helidon MP quickstart guides](../mp/guides/overview.md)
