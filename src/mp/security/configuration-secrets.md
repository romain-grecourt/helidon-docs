...
| \${GCM=...}   | Shared secret encryption, base64 value                                     | \${GCM=D/UgMzsNb265HU1NDvdzm7tACHdsW6u1PjYEcRkV/OLiWcI+ET6Q4MKCz0zHyEh9}                                                                                                                                                                                                                                                                                           |
...
```shell
java -jar <path-to-app-libs-dir>/helidon-config-encryption-{helidon-version}.jar \
...
```shell
java -jar <path-to-app-libs-dir>/helidon-config-encryption-{helidon-version}.jar \
  rsa /path/to/keystore.p12 keystorePassword publicCertAlias secretToEncrypt
```
