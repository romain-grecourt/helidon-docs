...
1.  Each non-root node has a name which distinguishes it from other
    ...
    <td><p>object<br />
    value</p></td>
    <td><p>member name of the node within its
    parent</p></td>
    </tr>
    <tr>
    <td><p>list</p></td>
    <td><p>element index of the node within the
...
| `as`       | Returns the `ConfigValue` with the correct type that has all methods of `Optional` and a few additional ones - see [`ConfigValue`](https://helidon.io/docs/v4/apidocs/io.helidon.config/io/helidon/config/ConfigValue.html) interface. |
...
<tbody>
<tr>
<td><p><code>asNodeList()</code></p></td>
<td><p>Returns a
...
<tr>
<td><p><code>hasValue()</code></p></td>
<td><p>For any node reports if the node has a
value. This can be true for any node type except
<code>MISSING</code>.</p></td>
</tr>
<tr>
<td><p><code>isLeaf()</code></p></td>
<td><p>Reports whether the node has no child
nodes. Leaf nodes have no children and has a single value.</p></td>
</tr>
<tr>
<td><p><code>key()</code></p></td>
<td><p>Returns the fully-qualified path of the
node using dotted notation.</p></td>
</tr>
<tr>
<td><p><code>name()</code></p></td>
<td><p>Returns the name of the node (the last
part of the key).</p></td>
</tr>
<tr>
<td><p><code>asNode()</code></p></td>
<td><p>Returns a
<code>ConfigValue&lt;Config&gt;</code> wrapped around the node</p></td>
</tr>
<tr>
<td><p><code>traverse()</code><br />
...
<td><p>Returns the <code>Type</code> enum
...
For example, the
[`application.properties`](introduction.md#create-simple-config-props)
