...
*disabled* (see
[`disableParserServices`](https://helidon.io/docs/v4/apidocs/io.helidon.config/io/helidon/config/Config.Builder.html#disableParserServices--)
...
- The config system will parse the resource `my-config` using the HOCON
  ...
  [HoconConfigParser](https://helidon.io/docs/v4/apidocs/io.helidon.config.hocon/io/helidon/config/hocon/HoconConfigParser.html).
  The `create()` method creates a config parser with default behavior.
...
[`EtcdConfigSourceBuilder`](https://helidon.io/docs/v4/apidocs/io.helidon.config.etcd/io/helidon/config/etcd/EtcdConfigSourceBuilder.html).
...
[`AbstractConfigSourceBuilder`](https://helidon.io/docs/v4/apidocs/io.helidon.config/io/helidon/config/AbstractConfigSourceBuilder.html)
...
[`GitConfigSourceBuilder`](https://helidon.io/docs/v4/apidocs/io.helidon.config.git/io/helidon/config/git/GitConfigSourceBuilder.html).
